//package running; // //import agent.*; //import world.Cell;
...
//
//
//    // @Refactor: add user defined capacity configuration.
//    AbstractAgent genNewAgent(String agentType) {
//        AbstractAgent agent;
//        switch (agentType) {
//            // Here, mcts is reactive.
//            case "mcts":
//                agent = new NMCTSAgent(40, norms);
//                break;
//            case "vbdi":
//                agent = new VBDIAgent(40, norms);
//                break;
//            case "fifo":
//                agent = new NFIFOAgent(40, norms);
//                break;
//            case "profifo":
//                agent = new ProactiveFIFOAgent(40, norms);
//                break;
//            default:
